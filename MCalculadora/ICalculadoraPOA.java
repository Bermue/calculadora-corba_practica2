 ...
 implements MCalculadora.ICalculadoraOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("MPH_KMH", new java.lang.Integer (4));
    _methods.put ("IVA", new java.lang.Integer (5));
    _methods.put ("Raiz", new java.lang.Integer (6));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // MCalculadora/ICalculadora/MPH_KMH
       {
         MCalculadora.Operadores Ops = MCalculadora.OperadoresHelper.read (in);
         double $result = (double)0;
         $result = this.MPH_KMH (Ops);
         out = $rh.createReply();
         out.write_double ($result);
         break;
       }

       case 5:  // MCalculadora/ICalculadora/IVA
       {
         MCalculadora.Operadores Ops = MCalculadora.OperadoresHelper.read (in);
         double $result = (double)0;
         $result = this.IVA (Ops);
       ...
       case 6:  // MCalculadora/ICalculadora/Raiz
       {
         MCalculadora.Operadores Ops = MCalculadora.OperadoresHelper.read (in);
         double $result = (double)0;
