...
public class _ICalculadoraStub extends org.omg.CORBA.portable.ObjectImpl implements MCalculadora.ICalculadora
{
  ...
  public double MPH_KMH (MCalculadora.Operadores Ops)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("MPH_KMH", true);
                MCalculadora.OperadoresHelper.write ($out, Ops);
                $in = _invoke ($out);
  ...
  public double IVA (MCalculadora.Operadores Ops)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("IVA", true);
                MCalculadora.OperadoresHelper.write ($out, Ops);
                $in = _invoke ($out);
                double $result = $in.read_double ();
                return $result;
